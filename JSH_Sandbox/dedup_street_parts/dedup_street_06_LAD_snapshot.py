...
#Load street data
street = sc.textFile('s3://ukpolice/street_LAD_year')
...
df_street_analysis.registerTempTable('street_LAD_year')

df_street_agg_LAD_snapshot = sqlCtx.sql('select LAD_code, LAD_name, SUM(TotalObs) as TotalObs, \
                       ...
                       \
                       from street_LAD_year\
                       \
                       group by LAD_code, LAD_name')

print("Number of records after aggregating to LAD snapshot level.")
count = df_street_agg_LAD_snapshot.count()
print(count)

#Save a copy of the file at this point into s3
#Change to rdd
rdd_street_agg_LAD_snapshot = df_street_agg_LAD_snapshot.rdd
#Make one file
rdd_street_agg_LAD_snapshot_1 = rdd_street_agg_LAD_snapshot.coalesce(1)
#Save
rdd_street_agg_LAD_snapshot_1.saveAsTextFile('s3://ukpolice/street_LAD_snapshot')
