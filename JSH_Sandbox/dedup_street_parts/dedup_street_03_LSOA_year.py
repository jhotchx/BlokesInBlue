...
#Load street data
street = sc.textFile('s3://ukpolice/street_LSOA_month')
...
#Change to rdd
rdd_street_agg_LSOA_year = df_street_agg_LSOA_year.rdd
#Make one file
rdd_street_agg_LSOA_year_1 = rdd_street_agg_LSOA_year.coalesce(1)
#Save
rdd_street_agg_LSOA_year_1.saveAsTextFile('s3://ukpolice/street_LSOA_year')
