...
#Load street data
street = sc.textFile('s3://ukpolice/street_MSOA_year')
...
df_street_analysis.registerTempTable('street_MSOA_year')

df_street_agg_MSOA_snapshot = sqlCtx.sql('select MSOA_code, MSOA_name, LAD_code, LAD_name, SUM(TotalObs) as TotalObs, \
                       ...
                       \
                       from street_MSOA_year\
                       \
                       group by MSOA_code, MSOA_name, LAD_code, LAD_name')

print("Number of records after aggregating to MSOA snapshot level.")
count = df_street_agg_MSOA_snapshot.count()
print(count)

#Save a copy of the file at this point into s3
#Change to rdd
rdd_street_agg_MSOA_snapshot = df_street_agg_MSOA_snapshot.rdd
#Make one file
rdd_street_agg_MSOA_snapshot_1 = rdd_street_agg_MSOA_snapshot.coalesce(1)
#Save
rdd_street_agg_MSOA_snapshot_1.saveAsTextFile('s3://ukpolice/street_MSOA_snapshot')
